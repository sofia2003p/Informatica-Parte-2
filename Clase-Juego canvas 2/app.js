...
class Finish {
    constructor(x, y, speed, width, height)
    {
        ...
        this.width = width;
        this.height = height;
        this.imagen = GAME.images.finish;
        this.enMovimiento = false;
        this.enReversa = false;
    }
...
function crearCarros(){
    ...
    GAME.objects.carros.push(new Carro(400, -700, 50+150*Math.random(), 100, 80, GAME.images.carro))
    ...
    GAME.objects.carros.push(new Carro(400, -500, 50+150*Math.random(), 100, 200))
    GAME.objects.carros.push(new Carro(400, -500, 50+150*Math.random(), 100, 200))
    GAME.objects.carros.push(new Carro(800, 700, -50+150*Math.random(), 100, 80, GAME.images.carro))
    GAME.objects.carros.push(new Carro(800, 700, -50+150*Math.random(), 100, 80, GAME.images.carro))
    GAME.objects.carros.push(new Carro(800, 700, -50+150*Math.random(), 100, 80, GAME.images.carro))
    ...
    GAME.objects.carros.push(new Carro(800, 700, -50+150*Math.random(), 100, 80, GAME.images.carro2))
    GAME.objects.carros.push(new Carro(800, 500, -50+150*Math.random(), 100, 200))
    GAME.objects.carros.push(new Carro(800, 700, -50+150*Math.random(), 100, 200))
    GAME.objects.carros.push(new Carro(800, 700, -50+150*Math.random(), 100, 80, GAME.images.carro2))
...
GAME.setup = function(){
    GAME.objects ={carros:[], player:new Venado(10, 300, 30, 50,70),player2:new Calle(400, 300, 30, 120, 1000), 
...
//         // se salió?
//         if(carro.x >= 1350 + carro.r || carro.x <= -carro.r ||
//             carro.y >= 603 + carro.r || carro.y <= -carro.r )
//         {
//             return true;
//         }
//     }
